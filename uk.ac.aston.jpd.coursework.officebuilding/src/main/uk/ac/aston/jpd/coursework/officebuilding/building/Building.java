 ...
 * Coursework
* 
*  @summary The building class holds the objects for the floors and the elevator and runs their functions accordingly.
* 
*/
public class Building {
	 ...
	 * @param e
	 * Passing in the elevator object
	 * @param noFloors
	 * Constructing and generating a number of floors based on the variable
	 * @param c
	 * floor uses comparator c as part of it's priority queue.
	 * 
	 */
	 ...
	 * @param sim
	 * elevator uses simulator as part of it's functions
	 * 
	 */
	...
	/**
	 * This method generate floors passing in the simulator and a button object for the constructor of floor.
	 * @param noFloors
	 * Uses this integer to know how many loops are required
	 * 
	 * @param c
	 * Floor uses the comparator as part of it's priority queue
	 * 
	 */
	 ...
	 * @param floorNumber
	 * this parameter get's the floor number
